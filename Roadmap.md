...
- [ ] **P0-001** Create the repository structure defined in `06_CODEBASE_GUIDE.md`.
- [ ] **P0-002** Add root `README.md`, `AGENT.md`, `Roadmap.md`, and canonical documents under `docs/project/`.
- [ ] **P0-003** Configure Python 3.12, `uv`, `pyproject.toml`, and locked backend dependencies.
- [ ] **P0-004** Configure Node.js, `pnpm`, Next.js, TypeScript, and locked frontend dependencies.
- [ ] **P0-005** Add root `Makefile` or equivalent stable command facade.
- [ ] **P0-006** Add `.editorconfig`, `.gitignore`, `.dockerignore`, formatter, and lint configurations.
- [ ] **P0-007** Add safe `.env.example` with placeholders only.
- [ ] **P0-008** Add Dockerfiles for web, API, and worker.
- [ ] **P0-009** Add local Docker Compose with PostgreSQL and local object-storage adapter.
- [ ] **P0-010** Add health/readiness placeholder routes and process startup/shutdown handling.

### Acceptance for Block 0A

- [ ] Fresh clone can install dependencies.
- [ ] Local stack starts without real provider credentials.
- [ ] No secret-shaped real values are committed.
- [ ] Repository tree matches documentation.
